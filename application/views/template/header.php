...
<head>
    ...
    <title>SI Mentor - Login Area</title>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user fa-fw"></i> Mentor<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url()?>mentor/register">Tambah Mentor</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url()?>mentor">List Mentor</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-users fa-fw"></i> Mentee<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url()?>mentee/register">Tambah Mentee</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url()?>mentee">List Mentee</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-circle-o-notch fa-fw"></i> Kelompok Mentoring<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?php echo base_url()?>kelompok/register">Tambah Kelompok</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url()?>kelompok">List Kelompok</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
